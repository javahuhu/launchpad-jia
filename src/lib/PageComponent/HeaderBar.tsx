        ...
        <div className="header-body">
          <div className="row align-items-center justify-content-between py-4">
            <div className="col-lg-6 col-7">
              ...
              >
                <ol className="breadcrumb breadcrumb-links" style={{ backgroundColor: "transparent", padding: 0, marginBottom: 0 }}>
                  ...
                  <h4 className="text-gray d-inline-block mb-0" style={{ fontSize: "16px", fontWeight: 500, marginTop: 6 }}>
                    {activeLink}
                  </h4>
                  ...
                  <li className="breadcrumb-item">
                    <div style={{
                      ...
                      <h4 className="d-inline-block mb-0" style={{
                        fontSize: "16px",
                        fontWeight: 550,
                        color: "black",
                        margin: 0
            ...
            <div className="col-lg-6 col-7">
              ...
              <div
                className={`dropdown-menu dropdown-menu-right mt-1 org-dropdown-anim${showAuthUserOptions ? " show" : ""
                  }`}
                style={{
                  maxWidth: "300px",
                  borderRadius: 10,
